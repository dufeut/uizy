...
|----------|----------|--------|
| [CSS Classes](./css-classes) | Static sites, quick prototypes | Add classes to HTML elements |
| [Web Components](./web-components) | Dynamic apps, JS interactivity | Use `<uizy-*>` custom elements |
...
- [CSS Classes](./css-classes) - Use utility classes for layout
- [Web Components](./web-components) - Use custom elements
