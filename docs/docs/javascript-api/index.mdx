...
|---------|---------|--------|
| [Components](./components) | Reusable CSS class generators | `uizy.use("path")` |
| [Actions](./actions) | Event handlers & side effects | `uizy.emit("path")` |
| [Stores](./stores) | Reactive state management | `uizy.$("path")` |
| [Directives](./directives) | Custom HTML attributes | `u-name="value"` |
| [Plugins](./plugins) | Bundled, namespaced modules | `uizy.plugin()` |
...
- [Components](./components) - Build reusable UI utilities
- [Actions](./actions) - Handle events and commands
- [Stores](./stores) - Manage reactive state
- [Directives](./directives) - Create custom attributes
